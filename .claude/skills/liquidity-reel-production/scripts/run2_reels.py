...
TXT = [
 ("t1", 0.35, 1.9,  "شنو يفضح الكسر<br>الوهمي قبل لا تدخل؟", 60, INK),
 ("t2", 2.30, 4.2,  "المستوى انلمس مرتين", 58, INK),
 ("t3", 4.40, 6.4,  "الأولى: فتيل… وإغلاق تحت", 56, INK),
 ("t4", 6.60, 8.3,  "اللي لحق الفتيل… ستوبه طق", 52, INK),
 ("t5", 8.50, 11.3, "نزلة سحبت السيولة اللي تحت", 52, INK),
 ("t6", 11.50, 13.4, "الثانية: إغلاق كامل فوق المستوى", 52, INK),
 ("t7", 13.70, 15.6, "فتيل بلا إغلاق… مجرد زيارة", 56, INK),
]
cfg = dict(w=W_, base=I1, openmax=RB, open_t=[[24,0.15],[25,0.45],[26,0.75]], story=story,
  ...
  txt=TXT, chip="الذهب · 30 دقيقة", res=f"‎+{PIPS} نقطة مشاها الكسر الحقيقي",
  cta_k="اكتب «كسر»", cta_s="أدزلك دليل الكسر الحقيقي كامل",
...
TXT = [
 ("t1", 0.35, 1.9,  "حاط ستوبك وين<br>الكل حاطه؟", 60, INK),
 ("t2", 2.30, 4.3,  "كل مستوى واضح… وراه ستوبات", 52, INK),
 ("t3", 4.50, 6.3,  "قمم متطابقة؟ ستوبات فوقها", 54, INK),
 ("t4", 6.50, 8.1,  "وقاع مزدوج؟ ستوبات تحته", 54, INK),
 ("t5", 8.30, 11.3, "غطس تحت القاع… وارتد", 52, INK),
 ("t6", 11.50, 13.4, "وطلع صوب سيولة القمم", 56, INK),
 ("t7", 13.70, 15.6, "الستوبات المتجمعة… عشا السوق", 50, INK),
]
cfg = dict(w=W_, base=18, openmax=27, open_t=[[28,0.15],[29,0.45],[30,0.75]], story=story,
  ...
  txt=TXT, chip="الناسداك · 30 دقيقة", res=f"‎+{PTS} نقطة من الارتداد للقمم",
  cta_k="اكتب «سيولة»", cta_s="خذ خريطة تجمعات السيولة كاملة",
  dur=19.8, res_t=15.9, cta_t=17.1, flash=(11.95,12.6), punch=(11.9,13.2,0.055),
