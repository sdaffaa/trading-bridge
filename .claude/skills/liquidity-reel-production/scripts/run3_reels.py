...
cfg["cam"] = [
  [0.0, 1.03, .5, .5], [2.3, 1.03, .5, .5],
  [3.5, 1.26, fx(15), fy(EQ)],                       # زوم على بناء القمم
  [6.3, 1.30, fx(XP), fy(W_[XP]["h"])],              # قريب من X الفخ
  [7.8, 1.26, fx(21), fy((W_[21]["l"]+W_[21]["h"])/2)],   # بان مع النزول
  [9.4, 1.32, fx(IR), fy((ZT+ZB)/2)],                # زوم على الدخلة بالزون
  [11.7, 1.30, fx(27), fy(W_[27]["c"])],
  [12.9, 1.28, fx(RB), fy(W_[RB]["c"])],             # الذروة (فوقها البانش)
  [15.3, 1.07, .5, .52], [16.6, 1.02, .5, .5], [19.8, 1.03, .5, .5]]
...
cfg["cam"] = [
  [0.0, 1.03, .5, .5], [2.3, 1.03, .5, .5],
  [3.6, 1.18, .45, fy(MID)],                          # خط النص ينرسم
  [5.4, 1.10, .5, .5],                                # نوسّع مع التظليل
  [7.4, 1.24, fx(31), fy(W_[31]["c"])],               # بان مع نزول الرجعة
  [9.7, 1.32, fx(37), fy((ZT+ZB)/2)],                 # زوم على الزون بالرخيص
  [10.9, 1.32, fx(IR), fy((ZT+ZB)/2)],                # الدخلة
  [12.9, 1.28, fx(40), fy(W_[40]["h"])],              # الارتداد (الذروة)
  [15.3, 1.07, .5, .5], [16.6, 1.02, .5, .5], [19.8, 1.03, .5, .5]]
