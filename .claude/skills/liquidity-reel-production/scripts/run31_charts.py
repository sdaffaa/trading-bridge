...
AR_SYM = {"GC=F": "الذهب", "NQ=F": "الناسداك", "YM=F": "الداو جونز",
          ...
          "SPY": "صندوق إس آند بي ٥٠٠", "IWM": "صندوق راسل ٢٠٠٠",
          "SLV": "صندوق الفضة", "LTC-USD": "اللايتكوين",
          "RB=F": "البنزين", "KC=F": "البُنّ",
          "6S=F": "عقد الفرنك", "6A=F": "عقد الأسترالي", "6J=F": "عقد الين",
          # أدوات دخلت المخزون مع توسيع `sheet_scan.SRC` إلى ٢٦ أداة
          "6B=F": "عقد الجنيه", "BTC-USD": "البتكوين", "SI=F": "الفضة",
          "PL=F": "البلاتين", "CL=F": "النفط", "NZDUSD=X": "النيوزيلندي/الدولار",
          # كون `daily_scan` على الفريم اليومي — أربعون أداة، وكلٌّ منها
          # يحتاج اسمَه ووحدةَ نقطته قبل أن يُرسم عليه شيء.
          "BZ=F": "برنت", "HG=F": "النحاس", "PA=F": "البلاديوم",
          "HO=F": "زيت التدفئة", "ZC=F": "الذرة", "ZW=F": "القمح",
          "ZS=F": "فول الصويا", "CT=F": "القطن", "SB=F": "السكر",
          "CC=F": "الكاكاو", "RTY=F": "راسل ٢٠٠٠", "ZN=F": "سند العشر سنوات",
          "ZB=F": "السند الطويل", "6E=F": "عقد اليورو", "6C=F": "عقد الكندي",
          "SOL-USD": "السولانا", "XRP-USD": "الريبل", "QQQ": "صندوق ناسداك ١٠٠",
          "GLD": "صندوق الذهب", "TLT": "صندوق السندات", "USO": "صندوق النفط",
          # دخلت المخزون مع توسيع `sheet_scan.SRC` إلى ١٠٣ أزواج
          # (2026-09-13): العملاتُ الرقمية تتداول في العطلة فهي
          # وحدها تُنبت نوافذ حين تُغلق بقيّةُ الأسواق.
          "DOGE-USD": "الدوجكوين", "ADA-USD": "الكاردانو",
          "LINK-USD": "التشين لينك", "AVAX-USD": "الأفالانش",
          "BNB-USD": "البي إن بي", "DOT-USD": "البولكادوت",
          "XLE": "صندوق الطاقة", "EEM": "صندوق الأسواق الناشئة"}
#: بالكلمة لا بالرقم: الشريحةُ «النحاس · ٣٠ دقيقة» تُرسم «النحاس ٣٠٠
#: دقيقة» — الفاصلةُ المنقوطة قبل رقمٍ عربي-هندي تلتصق به فتُقرأ صفراً
#: (رُئي في إطار ريل ٧٢). والقاعدةُ العامّة: لا «·» يليها رقمٌ هندي.
AR_TF = {"15m": "ربع ساعة", "30m": "نصف ساعة", "1h": "ساعة", "1d": "يومي"}
...
PIP = {"GC=F": 0.1, "NQ=F": 1.0, "YM=F": 1.0,
       ...
       "SPY": 0.01, "IWM": 0.01, "SLV": 0.01, "LTC-USD": 0.1,
       "RB=F": 0.0001, "KC=F": 0.05,
       "6S=F": 0.0001, "6A=F": 0.0001, "6J=F": 0.0000005,
       "6B=F": 0.0001, "BTC-USD": 1.0, "SI=F": 0.01,
       "PL=F": 0.1, "CL=F": 0.01, "NZDUSD=X": 0.0001,
       # وحدةُ كلِّ عقدٍ من مواصفاته لا بالتقدير: النحاس وزيت التدفئة
       # بالسنت/الرطل (0.0001)، والحبوب بربع سنت (0.25)، والسندات
       # بالكسر (١/٦٤ و١/٣٢)، والصناديق بالسنت.
       "BZ=F": 0.01, "HG=F": 0.0001, "PA=F": 0.1, "HO=F": 0.0001,
       "ZC=F": 0.25, "ZW=F": 0.25, "ZS=F": 0.25, "CT=F": 0.01,
       "SB=F": 0.01, "CC=F": 1.0, "RTY=F": 0.1, "ZN=F": 0.015625,
       "ZB=F": 0.03125, "6E=F": 0.0001, "6C=F": 0.0001,
       "SOL-USD": 0.01, "XRP-USD": 0.0001, "QQQ": 0.01,
       "GLD": 0.01, "TLT": 0.01, "USO": 0.01,
       # وحدةُ النقطة للعملات الرقمية من خانة التسعير المتداولة
       # لكلٍّ منها لا من قاعدةٍ واحدة: الدوجكوين خمسُ خاناتٍ
       # عشرية، والكاردانو أربع، وما سعرُه بالعشرات فخانتان.
       "DOGE-USD": 0.00001, "ADA-USD": 0.0001, "LINK-USD": 0.01,
       "AVAX-USD": 0.01, "BNB-USD": 0.1, "DOT-USD": 0.001,
       "XLE": 0.01, "EEM": 0.01}
...
def pips(r, a, b):
    """عدد النقاط — ووحدةُ النقطة تُطلب صراحةً لا تُفترض.

    كان الافتراضي 1.0 لأي أداة غير مُدرَجة، فطبع «عقد الجنيه» (‏6B=F‏،
    ووحدته 0.0001) حركةَ ٣٩ نقطة **صفراً** في `c_correct` — رقمٌ كاذب
    بلا أي إنذار. والصمتُ هنا أسوأ من السقوط: الأداة غير المعروفة تُوقف
    الحالة حتى تُدرَج وحدتُها."""
    assert r["sym"] in PIP, f'وحدة النقطة غير معروفة للأداة {r["sym"]} — أدرجها في PIP'
    return int(round(abs(a - b) / PIP[r["sym"]]))
...
def set_no_title(b):
    """يكتم عنوان الجارت الداخلي.

    في الجارت البطل بالكاروسيل يحمل `<h1>` الصفحةِ العنوانَ نفسه، فيظهر
    السطر مرّتين فوق بعضه — وهو حشوٌ يأكل من ارتفاع الجارت البطل."""
    _NT[0] = bool(b)


# أعرضُ شارةٍ في `CASES` («الإفلات — تأخر الدخول») تنتهي عند ~292px،
# فيبدأ فراغُ العنوان بعدها.
_BADGE_PAD = 296


def _title(Wd, txt, col=INK, fs=19):
    """عنوان الجارت موسَّطاً — ويُصغَّر إن لم يسع بجانب الشارة.

    كان القياس ثابتاً، فطال عنوان `c_trap` (٤٤ حرفاً) حتى دخل تحت الشارة
    الحمراء وانقُصّ آخره على «تحت السع». والحلّ قياسٌ لا اقتصاص: عرضُ
    النصّ يُقدَّر ثم يُخفَّض المقاس حتى يسع الفراغ الفعلي."""
    if _mini() or _NT[0]: return ""
    ...
    # يُوسَّط في **الفراغ الباقي** لا في اللوحة كلّها: التوسيط الكامل
    # يدفع نصفَ العنوان تحت الشارة، والتصغيرُ وحده يجعله مجهرياً.
    x0, x1 = _BADGE_PAD * _SC[0], Wd - 18
    avail = x1 - x0
    w = len(txt) * fs * 0.52 * _SC[0]
    if avail > 0 and w > avail:
        fs = max(13, fs * avail / w)
    return htext((x0 + x1) / 2, y, txt, col, round(fs * _SC[0]))
