...
OUT = os.path.join(HERE, "out_car2")
os.makedirs(OUT, exist_ok=True)
for f in glob.glob(os.path.join(OUT, "*.png")): os.remove(f)

CHROME = glob.glob("/opt/pw-browsers/chromium-*/chrome-linux/chrome")[0]
names = ["01-cover", "02-what-is-retest", "03-channel", "04-consolidation",
         "05-liquidity-sweep", "06-playbook", "07-quote", "08-cta"]
...
with sync_playwright() as p:
    ...
    pg.goto("file://" + os.path.join(HERE, "carousel2.html"))
